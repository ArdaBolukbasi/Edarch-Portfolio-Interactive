<div align="center">
  ...
  <p style="font-family: serif; font-size: 1.1em; color: #555; font-style: italic; margin-top: -10px;">
...
<table width="100%">
  ...
  <tr>
    <td valign="top">
      <strong>1. Platform Limitations:</strong><br> 
...
<table width="100%" style="border-collapse: collapse;">
  ...
  <tr>
    <td colspan="2" align="center" style="padding-bottom: 40px;">
      ...
      <a href="https://portfolio.edarch.studio/" target="_blank">
        <img src="Spread.png" width="100%" style="border-radius:2px; border:1px solid #ddd; box-shadow: 0 10px 30px rgba(0,0,0,0.1);" title="Click to Open">
      </a>
      <p style="font-size: 0.8em; color: #888;"><em>Realistic double-page layout with hardware-accelerated animations</em></p>
    </td>
  </tr>
  ...
  <tr>
    <td width="30%" valign="top" align="center" style="padding-right: 20px; border-right: 1px solid #eee;">
      ...
      <a href="https://portfolio.edarch.studio/" target="_blank">
        <img src="mobile.jpeg" width="200" style="border-radius:10px; border:4px solid #222; box-shadow: 0 5px 20px rgba(0,0,0,0.15);">
      </a>
      <p style="font-size: 0.8em; color: #888; margin-top: 10px;"><em>Responsive single-page view</em></p>
    </td>
    <td width="70%" valign="middle" align="center" style="padding-left: 20px;">
      <h4 style="letter-spacing: 1px;">INTEGRATED CONTACT UI</h4>
      <a href="https://portfolio.edarch.studio/iletisim_en.html" target="_blank">
        <img src="Contact.png" width="100%" style="border-radius:2px; border:1px solid #ddd; box-shadow: 0 10px 30px rgba(0,0,0,0.1);">
      </a>
      <p style="font-size: 0.8em; color: #888;"><em>Seamless form integration within the app</em></p>
    </td>
  </tr>
</table>
...
<div align="center">
  ...
  <a href="https://github.com/ArdaBolukbasi">
